...
ggplot(new, aes(x = Dátum, y= c(conf), color = "Dátum")) + geom_line() +
    ggplot(new, aes(x = Dátum, y= c(cured), color = "Dátum")) + geom_line() + 
ggplot(new, aes(x = Dátum, y= c(deaths), color = "Dátum")) + geom_line()
```
